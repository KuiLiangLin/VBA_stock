...
'''''''''''''''''''''''''''''''''''''''''''''''''''''''
For y = 7 To 4 Step -1   'sheet 4 TO sheet 7
'''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    For x = 3 To 947
        ...
        Sheets("collect_M").Cells(1, w + 1) = Sheets(y).Name & Sheets(y).Cells(12, i + 2)
        
        Sheets("collect_M").Cells(x, w) = Sheets(y).Cells(r, i)
        Sheets("collect_M").Cells(x, w + 1) = Sheets(y).Cells(r, i + 2)
